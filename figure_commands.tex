...
\newcommand{\FigTwoCaption}{Areas in orange (from Top500 data) and in blue (from Top8000) fill the allowed regions for Asp, Trp, and Ile. The extensive areas in green are where the two systems both declare allowed conformations. \textcolor{changecolor}{See also Figure S1.}}
